...
namespace ViewModel
{
	public class ConstructorViewModel : MonoBehaviour
	{
		...
		private void Initialize(IShip ship)
		{
			...
			_layout = new ShipLayout(Ship.Model.Layout, ship.Model.Barrels, ship.Components, ship.Model.Stats.IgnoreWeaponClass, debug);
			
			NameText.text = _localization.GetString(ship.Name);

            _leftPlatformLayout = ship.FirstSatellite != null ? new ShipLayout(ship.FirstSatellite.Information.Layout, 
				ship.FirstSatellite.Information.Barrels, ship.FirstSatellite.Components, ship.Model.Stats.IgnoreWeaponClass, debug) : null;
            _rightPlatformLayout = ship.SecondSatellite != null ? new ShipLayout(ship.SecondSatellite.Information.Layout, 
				ship.SecondSatellite.Information.Barrels, ship.SecondSatellite.Components, ship.Model.Stats.IgnoreWeaponClass, debug) : null;
