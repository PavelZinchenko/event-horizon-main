...
namespace ViewModel
{
	public class ComponentInfoViewModel : MonoBehaviour
	{
		...
		public void UnlockButtonPressed()
		{
			...
			var component = layout.Ship.GetComponent(componentId);
		...
		private void UpdateDescription(Constructor.Component.IComponent component)
		{
			...
			RequiredCellText.text = _component.Data.CellType == CellType.Weapon ? SlotTypeToString(_component.Data.WeaponSlotType) : string.Empty;
