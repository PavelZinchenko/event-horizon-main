...
namespace ViewModel
{
	public class ShipLayoutViewModel : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IEndDragHandler, IBeginDragHandler, IDragHandler
	{
		...
		[SerializeField] public BlockViewModel WeaponBlock;
		[SerializeField] public BlockViewModel InnerBlock;
		[SerializeField] public BlockViewModel OuterBlock;
		[SerializeField] public BlockViewModel IoBlock;
		[SerializeField] public BlockViewModel EngineBlock;
		[SerializeField] public RectTransform AllowedBlock;
		[SerializeField] public RectTransform DeniedBlock;
		[SerializeField] public RectTransform LockIcon;
		[SerializeField] public ComponentIconViewModel ComponentIcon;
        ...
        {
			_pointerDownTime = Time.realtimeSinceStartupAsDouble;
        }
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
			...
			if (id < 0 || _layout.GetComponent(id).Locked || Input.touches.Length > 1 || Time.realtimeSinceStartupAsDouble - _pointerDownTime < 0.1)
            {
