    ...
    public class SatellitesPanel : MonoBehaviour
    {
        ...
        private void UpdateItems()
        {
            ...
            if (_isEditorMode)
            {
                ...
                _itemsLayoutGroup.transform.InitializeElements<SatelliteListItem, SatelliteBuild>(builds, UpdateSatellite);
            }
            else if (_playerInventory != null)
            {
                var satellites = _playerInventory.Satellites.Items.OrderBy(data => data.Key.Name);
                _itemsLayoutGroup.transform.InitializeElements<SatelliteListItem, KeyValuePair<Satellite, ObscuredInt>>(satellites, UpdateSatellite);
            }
        }
