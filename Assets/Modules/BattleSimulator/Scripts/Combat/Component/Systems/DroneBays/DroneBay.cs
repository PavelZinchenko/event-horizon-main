...
namespace Combat.Component.Systems.DroneBays
{
    public class DroneBay : SystemBase, IDroneBay
    {
            ...
            : base(data.KeyBinding, data.DroneBay.ControlButtonIcon)
        {
            ...
            _totalBuildCycles = data.DroneBay.BuildExtraCycles;
            _remainingBuildCycles = _totalBuildCycles;
            ...
            builder.Bonuses.TurnRateMultiplier = StatMultiplier.FromValue(stats.SpeedMultiplier + (random.NextFloat() - 0.5f) * 0.4f);
        ...
        public override float Cooldown
        {
            get
            {
                if (_dronesLeft > 0)
                    ...
                    return _replicator.Cooldown + _replicator.BuildTime * _remainingBuildCycles;
                else
                    return 1.0f;
            }
        }
        ...
        public bool TryRestoreDrone()
        {
            ...
            if (_remainingBuildCycles > 0)
            {
                _remainingBuildCycles--;
                return true;
            }
