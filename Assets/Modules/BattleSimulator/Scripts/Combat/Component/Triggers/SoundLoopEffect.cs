...
{
    public class SoundLoopEffect : IUnitEffect
    {
        public SoundLoopEffect(ISoundPlayer soundPlayer, AudioClipId audioClipId, ConditionType playCondition, ConditionType stopCondition)
        {
        ...
        public SoundLoopEffect(ISoundPlayer soundPlayer, AudioClip audioClip, ConditionType playCondition, ConditionType stopCondition)
        {
            _soundPlayer = soundPlayer;
        ...
        private void Play()
        {
            ...
            if (_audioClip)
                _soundPlayer.Play(_audioClip, GetHashCode(), true);
            else
