...
namespace Combat.Factory
{
    public class SpaceObjectFactory
    {
        ...
        public IUnit CreateExplosion(Vector2 position, float radius, DamageType damageType, float damage, IShip owner, Color color, float impulseMultiplier = 1.0f)
        {
            ...
            var unit = CreateArea(position, Vector2.zero, radius, 0.3f, owner);
        ...
        public IUnit CreateSmokeExplosion(Vector2 position, float radius, DamageType damageType, float damage, IShip owner, Color color, float impulseMultiplier = 1.0f)
        {
            const float lifetime = 0.5f;
            var unit = CreateArea(position, Vector2.zero, radius, 0.3f, owner);
        ...
        public IUnit CreateStrongExplosion(Vector2 position, float radius, DamageType damageType, float damage, IShip owner, Color color, float lifetime = 0.5f, float impulseMultiplier = 1.0f)
        {
            var unit = CreateArea(position, Vector2.zero, radius, 0.3f, owner);
        ...
        public IUnit CreateFlash(Vector2 position, float radius, DamageType damageType, float damage, IShip owner, Color color, float impulseMultiplier = 1.0f)
        {
            const float lifetime = 0.3f;
            var unit = CreateArea(position, Vector2.zero, radius, lifetime, owner);
        ...
        public IUnit CreateWeb(Vector2 position, float radius, float lifetime, DamageType damageType, float damage, float deceleration, IShip owner, Color color)
        {
            var unit = CreateDeceleratingArea(position, Vector2.zero, radius, deceleration, lifetime, owner);
        ...
        public IUnit CreateEmp(Vector2 position, float radius, DamageType damageType, float damage, float shieldDamage, float energyDrain, IShip owner, Color color)
        {
            const float lifetime = 0.5f;
            var unit = CreateArea(position, Vector2.zero, radius, lifetime, owner);
        ...
        public IUnit CreateCloud(Vector2 position, Vector2 velocity, float lifetime, float radius, DamageType damageType, float damage, IShip owner, Color color)
        {
            var unit = CreateArea(position, velocity, radius, lifetime, owner);
        ...
        private ShortLivedObject CreateArea(Vector2 position, Vector2 velocity, float radius, float lifetime, IShip owner)
        {
        ...
        private ShortLivedObject CreateDeceleratingArea(Vector2 position, Vector2 velocity, float radius, float deceleration, float lifetime, IShip owner)
        {
