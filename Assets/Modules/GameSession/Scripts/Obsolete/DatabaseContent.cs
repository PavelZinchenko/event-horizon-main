...
namespace Session
{
    class DatabaseContentObsolete
    {
        public DatabaseContentObsolete(ContentFactoryObsolete factory, InAppPurchasesData purchases = null, AchievementData achievements = null)
        {
        ...
        public static DatabaseContentObsolete TryDeserialize(byte[] data, int startIndex, ContentFactoryObsolete factory)
        {
            ...
            var content = new DatabaseContentObsolete(factory);
        ...
        private void DeserializeLegacyData(string key, byte[] data, ContentFactoryObsolete factory)
        {
            switch (key)
            {
                default:
        ...
        private IEnumerable<ISerializableDataObsolete> Data
        {
            get
            {
                yield return Game;
