...
{
    public class ShopData : ISerializableDataObsolete
	{
        [Inject]
		...
		private void Deserialize(byte[] buffer)
		{
			...
			{
				UnityEngine.Debug.Log("ShopData: incorrect data version");
                throw new ArgumentException();
            }
        ...
        internal Dictionary<int, Dictionary<string, Purchase>> _purchases = new Dictionary<int, Dictionary<string, Purchase>>();
