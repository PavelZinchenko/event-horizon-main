...
{
    public class InventoryData : ISerializableDataObsolete
    {
        [Inject]
        ...
        internal readonly GameItemCollection<long> _components = new GameItemCollection<long>();
		internal readonly GameItemCollection<int> _satellites = new GameItemCollection<int>();
    }
}
