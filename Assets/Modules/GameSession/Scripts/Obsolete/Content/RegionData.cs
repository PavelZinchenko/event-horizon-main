...
{
    public class RegionData : ISerializableDataObsolete
	{
        [Inject]
        ...
        internal Dictionary<int, int> _defeatedFleetCount = new Dictionary<int, int>();
        internal Dictionary<int, int> _factions = new Dictionary<int, int>();
	}
}
