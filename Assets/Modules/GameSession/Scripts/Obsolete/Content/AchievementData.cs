...
{
    public class AchievementData : ISerializableDataObsolete
    {
        [Inject]
        ...
        public bool IsUnlocked(int type)
        {
            return _unlockedAchievements.Contains(type);
        }

        public void UnlockAchievement(int type)
        {
            IsChanged |= _unlockedAchievements.Add(type);
        }
        ...
        internal HashSet<int> _unlockedAchievements = new HashSet<int>();
    }
}
