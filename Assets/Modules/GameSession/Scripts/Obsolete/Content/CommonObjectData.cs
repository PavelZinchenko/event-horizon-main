...
{
    public class CommonObjectData : ISerializableDataObsolete
	{
        [Inject]
		...
		internal Dictionary<int, long> _usedTime = new Dictionary<int, long>();
		internal Dictionary<int, int> _intValues = new Dictionary<int, int>();
	}
}
