...
{
    public class StarMapData : ISerializableDataObsolete
	{
        ...
        [Inject]   
        public StarMapData( byte[] buffer = null)
        {
            IsChanged = true;
		...
		internal Dictionary<int, int> _stardata = new Dictionary<int, int>();
		internal Dictionary<long, int> _planetdata = new Dictionary<long, int>();
		internal Dictionary<int, string> _bookmarks = new Dictionary<int, string>();
	}
}
