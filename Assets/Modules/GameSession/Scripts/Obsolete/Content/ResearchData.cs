...
{
    public class ResearchData : ISerializableDataObsolete
	{
        [Inject]
		...
		public void RemoveTechnology(ItemId<Technology> id)
		{
			IsChanged |= _technologies.Remove(id.Value);
		}
        ...
        internal HashSet<int> _technologies = new HashSet<int>();
		internal Dictionary<int, ObscuredInt> _researchPoints = new Dictionary<int, ObscuredInt>();
	}
}
