...
{
    public class FleetData : ISerializableDataObsolete
    {
        [Inject]
        ...
        internal readonly ObservableCollection<ShipData> _ships = new ObservableCollection<ShipData>();
		internal readonly ObservableCollection<HangarSlotInfo> _hangarSlots = new ObservableCollection<HangarSlotInfo>();
