...
{
    public class QuestData : ISerializableDataObsolete
    {
        [Inject]
        ...
        internal Dictionary<int, int> _factionRelations = new Dictionary<int, int>();
        internal Dictionary<int, int> _characterRelations = new Dictionary<int, int>();
        internal readonly Dictionary<int, QuestStatistics> _statistics = new Dictionary<int, QuestStatistics>();
        internal readonly Dictionary<int, Dictionary<int, QuestProgressInternal>> _progress = new Dictionary<int, Dictionary<int, QuestProgressInternal>>();
        ...
        internal struct QuestProgressInternal
        {
            public int Seed;
            public int ActiveNode;
            public long StartTime;
