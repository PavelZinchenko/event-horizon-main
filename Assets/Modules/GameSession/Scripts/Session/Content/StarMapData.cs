...
namespace Session.Content
{
    public class StarMapData : ISerializableData
	{
        ...
        [Inject]   
        public StarMapData(PlayerPositionChangedSignal.Trigger playerPositionChangedTrigger, NewStarSecuredSignal.Trigger newStarExploredTrigger, byte[] buffer = null)
        {
